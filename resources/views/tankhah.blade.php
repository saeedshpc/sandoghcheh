<x-layout>
    ...
    <div id="table-pagination-div">
        ...
        <x-table>
            ...
            <x-table-row>
                <x-table-td>bn-002</x-table-td>
                <x-table-td>خرید چسب</x-table-td>
                <x-table-td>11/500</x-table-td>
                <x-table-td>الهه خداپرست</x-table-td>
                <x-table-td class="text-green-600">پرداخت شده</x-table-td>
                <x-table-td>کارت تنخواه بانوریس</x-table-td>
                <x-table-td>1401-08-21</x-table-td>
                <td class="table-td">
